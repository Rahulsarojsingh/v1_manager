    ...
    <section className="py-24 px-4">
      ...
      >
        ...
        <p className="text-lg sm:text-xl text-zinc-400 mb-10 max-w-2xl mx-auto">
          Join construction teams worldwide managing projects more efficiently. Start free, no credit card required.
        </p>
        ...
        <p className="mt-8 text-sm text-zinc-500">Starter plan is free forever. Professional plans start at $49/month.</p>
      </motion.div>
    </section>
  )
}
