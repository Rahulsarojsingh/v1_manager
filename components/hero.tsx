    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-zinc-400">Available on iOS, Android & Web</span>
        </motion.div>
        ...
        >
          Powerful construction app for multi-project management with reliable data security and privacy. Real-time team synchronization across all platforms.
        </motion.p>
        ...
        >
          <p className="text-sm text-zinc-400">
            Available on <span className="text-zinc-300 font-medium">Google Play</span> and <span className="text-zinc-300 font-medium">App Store</span>
          </p>
        </motion.div>
      </div>
    </section>
