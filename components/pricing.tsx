...
const plans = [
  {
    ...
    features: ["5 projects", "5 team members", "Daily work logs", "Basic task management", "Community support", "Mobile & Web access"],
    cta: "Get Started",
    highlighted: false,
  },
  {
  ...
  {
    name: "Enterprise",
    description: "For large-scale construction organizations",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto mb-8">
            Start free and scale with your business. Transparent pricing with no hidden fees.
          </p>
