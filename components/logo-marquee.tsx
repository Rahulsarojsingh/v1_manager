...
const logos = [
  { name: "BuildCorp", width: 100 },
  { name: "ConstrTech", width: 90 },
  { name: "SiteFlow", width: 80 },
  { name: "ProjectHub", width: 100 },
  { name: "BuildPass", width: 90 },
  { name: "ConstructNow", width: 110 },
  { name: "SafeTrack", width: 85 },
  { name: "BuildSync", width: 95 },
]
...
export function LogoMarquee() {
  ...
  return (
    <section ref={ref} className="py-16 overflow-hidden">
      ...
      >
        <p className="text-sm text-zinc-500 uppercase tracking-wider font-medium">Trusted by leading construction companies</p>
      </motion.div>
